...
namespace FinalProject.Controllers
{
    public class ClaimsController : Controller
    {
        ...
        public ClaimsController(AndrecatarinadatabaseContext context)
        {
            _context = context;
        }
        ...
        {
            var andrecatarinadatabaseContext = _context.Claims.Include(c => c.Vehicle);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AndrecatarinadatabaseContext.Claims'  is null.");
            }
            var claim = await _context.Claims.FindAsync(id);
            if (claim != null)
            {
